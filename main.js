...
Mousetrap.bind(['0'], function() {sound27(); 
                              });

Mousetrap.bind(['1'], function() {sound28(); 
                              });

Mousetrap.bind(['2'], function() {sound29(); 
                              });

Mousetrap.bind(['3'], function() {sound30(); 
                              });

Mousetrap.bind(['4'], function() {sound31(); 
                              });

Mousetrap.bind(['5'], function() {sound32(); });

Mousetrap.bind(['6'], function() {sound33(); });

Mousetrap.bind(['7'], function() {sound34(); });

Mousetrap.bind(['8'], function() {sound35(); });

Mousetrap.bind(['9'], function() {sound36(); });

Mousetrap.bind(['!'], function() {sound37(); });

Mousetrap.bind(['@'], function() {sound38(); });

Mousetrap.bind(['#'], function() {sound39(); });

Mousetrap.bind(['$'], function() {sound40(); });

Mousetrap.bind(['%'], function() {sound41(); });

Mousetrap.bind(['^'], function() {sound42(); });